...
var _newService = require("./new-service");
var _newServiceDefault = parcelHelpers.interopDefault(_newService);
const newsApiService = new (0, _newServiceDefault.default)();
const refs = {
...
function onSearch(e) {
    ...
    newsApiService.fetchArticles().then((articles)=>{
        ...
        refs.articlesContainer.insertAdjacentHTML('beforeend', appendArticlesMarkup(articles));
...
},{"./new-service":"cZ5Pz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cZ5Pz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
