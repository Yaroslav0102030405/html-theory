...
// git add - додати файли які будуть збережені
// git commit - m" - щоб зберегти файли логально на компьютер
// git push - щоб відправити коміти на відалений репозиторій
// git log - щоб подивитися історію зроблених комітов
// git status - перевірити що все ок
// git checkout - переключитися на гілку
// git merge - об'єднати окремі гілки в одну
// git clone - скопіювати відаленний репозиторій з серверу

// git fetch - скачати данні з сервера собі на компрьютер в локальний репозиторій але потім треба виконати команду git pull
// git pull - скачати всі данні з серверу собі на компрьютер в локальний репозиторій (одна команда замість 2)
